<x-layout>
    <div class="bg-white rounded-lg shawdow-md w-full md:max-w-xl mx-auto mt-12 p-8 py-12">
        <h2 class="txt-4xl text-center font-bold mb-4">Register</h2>
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <button type="submit"
                class="w-full bg-blue-500 hover:bg0blue-600 text-white px-4 py-2 rounded- focus:outline-none">Register</button>
