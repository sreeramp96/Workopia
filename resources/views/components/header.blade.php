<header class="bg-blue-900 text-white p-4" x-data="{ open: false }">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <x-nav-link url="/jobs/saved" :active="request()->is('jobs/saved')"> Saved </x-nav-link>
            <x-nav-link url="/login" :active="request()->is('login')"> Login </x-nav-link>
            <x-nav-link url="/register" :active="request()->is('register')"> Register </x-nav-link>
            <x-nav-link url="/" :active="request()->is('dashboard')" icon="gauge"> Dashboard </x-nav-link>
    ...
    <nav x-show="open" @click.away="open = false" id="mobile-menu"
        ...
        <x-nav-link url="/jobs/saved" :active="request()->is('jobs/saved')" :mobile="true"> Saved </x-nav-link>
        ...
        <x-nav-link url="/" :active="request()->is('dashboard')" icon="gauge" :mobile="true"> Dashboard </x-nav-link>
