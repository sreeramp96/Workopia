<x-layout>
    <x-slot name="title">Edit Job Listings</x-slot>
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text-area id="requirements" name="requirements" label="Requierments"
                placeholder="Bachelor's degree in Computer Science" :value="old('requierements', $job->requirements)" />
            ...
            <x-inputs.text id="zipcode" name="zipcode" label="Zipcode" placeholder="002214" :value="old('zipcode', $job->zipcode)" />
